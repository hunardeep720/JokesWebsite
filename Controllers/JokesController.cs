...
namespace JokesWebsite.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            var filteredJokes = await _context.Jokes
                .Where(j => j.JokeQuestion.Contains(searchQuery) || j.JokeAnswer.Contains(searchQuery))
                .ToListAsync();

            return View("Index", filteredJokes);
        }
        ...
        {
            Console.WriteLine("Create action triggered"); // Debugging log
